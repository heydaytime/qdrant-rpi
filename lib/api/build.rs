...
fn configure_validation(builder: Builder) -> Builder {
    builder
        ...
        .validates(&[
            ...
            ("RpiConfig.max_shells", "range(min = 2, max = 20)"),
            ("RpiConfig.base_epsilon", "range(min = 0.001, max = 10.0)"),
            ("RpiConfig.demotion_threshold", "range(min = 1, max = 100)"),
            ("RpiConfig.promotion_threshold", "range(min = 1, max = 1000)"),
            ("RpiConfig.rebalance_threshold", "range(min = 1.5, max = 10.0)"),
        ], &[
